...
public class AgendaDao 
{
    ...
    public boolean checkLogin(String email, String senha) throws NoSuchAlgorithmException //nao precisa no veiculo
    {
    ...
    public void create(Agenda a) throws NoSuchAlgorithmException
    {
        ...
        try
        {
            ...
            JOptionPane.showMessageDialog(null, "Usuário " + a.getNome() + " salvo com sucesso");
        }
        catch (SQLException e)
        {
            JOptionPane.showMessageDialog(null, "Erro: " + e.getMessage());
    ...
    public void update(Agenda a) throws NoSuchAlgorithmException
    {
       ...
       BigInteger cripto;
        try
        {
            ...
            JOptionPane.showMessageDialog(null, "Usuário " + a.getNome() + " modificado com sucesso");
        }
        catch (SQLException e)
        {
            JOptionPane.showMessageDialog(null, "Erro: " + e.getMessage());
    ...
    public void delete(Agenda a)
    {
        ...
        try
        {
            ...
            if (JOptionPane.showConfirmDialog(null, "Tem certeza que deseja excluir este Usuário(a)", "Exclusão", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION) 
            {
